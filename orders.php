        ...
        <div class="row">
          <div class="col-lg-6 mb-5 mb-lg-0">
            ...
            if($result = $conn->query($sql)){
                ...
                echo "<table class='table table-hover'><tr><th>ID</th><th>Имя заказчика</th><th>Почта</th><th>Номер телефона</th><th>Модель смартфона</th><th>Вид выполненного ремонта</th><th>Удобный день недели</th><th>Удобное время</th><th>Дата оформления заказа</th></tr>";
