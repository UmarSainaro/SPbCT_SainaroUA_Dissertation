              ...
              <nav class="site-navigation text-right" role="navigation">
                <div class="container">
                  ...
                  <ul class="site-menu js-clone-nav d-none d-lg-block">
                    <li><a href="uchet.php">Статус заказов</a></li>
      ...
      <div class="container">
        <div class="row">
          <div class="col-lg-6 mb-5 mb-lg-0">
            <h2 class="font-weight-bold text-black mb-5">Список оформленных заказов</h2>
            <?php
            ...
            if($result = $conn->query($sql)){
                ...
                echo "<table class='table table-hover'><tr><th>ID</th><th>Имя</th><th>Почта</th><th>Номер телефона</th><th>Модель смартфона</th><th>Вид ремонта</th><th>Удобный день недели</th><th>Удобное время</th><th>Дата заказа</th></tr>";
            foreach($result as $row){
                echo "<tr>";
                    ...
                    echo "<td>" . $row["smartphone"] . "</td>";
                    echo "<td>" . $row["remont"] . "</td>";
                    echo "<td>" . $row["callday"] . "</td>";
        ...
        $conn->close();
        ?>
        <a style="color: white;" class="btn btn-success" href="edit.php">Редактировать</a>
          </div>
          </div>
          </div>
          </div>
