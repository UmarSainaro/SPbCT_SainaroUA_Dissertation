              ...
              <nav class="site-navigation text-right" role="navigation">
                <div class="container">
                  ...
                  <ul class="site-menu js-clone-nav d-none d-lg-block">
                    <li><a href="change.php">Список оформленных заказов</a></li>
      ...
      <div class="container">
        <div class="row">
          <div class="col-lg-6 mb-5 mb-lg-0">
            <h2 class="font-weight-bold text-black mb-5">Статус заказов</h2>
            <?php
            ...
            if($result = $conn->query($sql)){
                ...
                echo "<table class='table table-hover'><tr><th>ID</th><th>Имя заказчика</th><th>Номер телефона</th><th>Модель смартфона</th><th>Вид выполненного ремонта</th><th>Статус заказа</th><th>Дата завершения</th></tr>";
            foreach($result as $row){
                echo "<tr>";
                    echo "<td>" . $row["iduchet"] . "</td>";
