      ...
      <div class="container">
        <div class="row">
          <div class="col-lg-6 mb-5 mb-lg-0">
            <h2 class="font-weight-bold text-black mb-5">Список пользователей</h2>
            <?php
            ...
            if($result = $conn->query($sql)){
                ...
                echo "<table class='table table-hover'><tr><th>ID</th><th>Логин</th><th>Почта</th><th>Пароль</th></tr>";
