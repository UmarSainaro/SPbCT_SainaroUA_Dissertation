...
<div class="site-navbar-wrap">
          ...
          <div class="site-navbar">
            <div class="container py-1">
              <div class="row align-items-center">
                <div class="col-2">
                  <h1 class="mb-0 site-logo"><a href="index.html"><img src="images/remont.png" width="50" height="50"></a></h1>
                </div>
                <div class="col-10">
  ...
  <div id="form" style="background:linear-gradient( rgba(0, 0, 0, 0.4), rgba(0, 0, 0, 0.4) ), url(images/fon.jpg); 
